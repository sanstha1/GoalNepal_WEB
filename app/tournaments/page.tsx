...
// ─── Field Component (MUST be outside modal to prevent remount on re-render) ──
      ...
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          onBlur={(e) => {
            ...
            e.target.style.backgroundColor = error ? "#fff1f2" : "#f9fafb";
          }}
        />
      </div>
      {error && (
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <Field
                ...
                onChange={setField("captainPhone")}
              ...
              <Field
                ...
                onChange={setField("captainEmail")}
              ...
              <Field
                ...
                placeholder={tournament.type === "futsal" ? "e.g. 5" : "e.g. 11"}
                icon={<Hash size={15} />}
                type="number"
            ...
            <div className="px-6 pb-6 space-y-2">
              ...
              <button
                onClick={onClose}
                disabled={isLoading}
                className="w-full h-10 text-sm text-gray-500 hover:text-gray-700 transition-colors disabled:opacity-60"
              >
                Cancel
              </button>
            </div>
...
function TournamentCard({ tournament }: { tournament: Tournament }) {
  ...
  const handleToggle = () => {
    ...
    toast[saved ? "info" : "success"](
      saved ? "Tournament removed from saved." : "Tournament saved successfully!"
    );
  };
  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-200 flex flex-col">
        <div className="relative h-48 bg-gray-100">
          ...
          <div className="absolute top-3 left-3">
            <span className={`text-xs font-bold px-3 py-1 rounded-full ${
              tournament.type === "football" ? "bg-black text-white" : "bg-white text-black border border-black"
            }`}>
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          <button
            ...
            className="mt-auto w-full bg-black text-white py-3 rounded-xl font-bold text-sm hover:bg-gray-800 transition-colors"
          >
            Register
          </button>
        </div>
      ...
      {showModal && (
        <RegistrationModal tournament={tournament} onClose={() => setShowModal(false)} />
      )}
    </>
  );
}
